...
from .views import CreateUserView, UserListView, AdminListView, CreateAdminView, ModeratorListView, CreateModeratorView, UserDetailView, AdminDetailView, LoginView
urlpatterns = [
